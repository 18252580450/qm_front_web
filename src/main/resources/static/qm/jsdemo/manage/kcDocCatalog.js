require(["jquery", "loading", 'util', "easyui", 'ztree-exedit', "transfer"], function ($, Loading, Util, Transfer) {
    ...
    function districtManage() {
        $search = $([
            ...
            "<div class='formControls col-2'>",
            "<input type='text' class='easyui-combobox' name='channel' disabled='disabled' style='width:100%;height:30px' >",
            "</div>",
            // "<label class='form-label col-2'>REGN_ID：</label>",
            // "<div class='formControls col-2'>",
            // "<input type='text' class='easyui-combobox' name='regnId' readonly='readonly' style='width:100%;height:30px' >",
            // "</div>",
            "</div>",
            "<div class='row cl'>",
    ...
    function initMenuTree() {
        ...
        var setting = {
            async: {
                ...
                type: "GET",
                enable: true,
                url: Util.constants.CONTEXT + "/kc/doc/catalogsvc/msa/queryDocCatalog",
                autoParam: ["codeValue"],
                dataFilter: filter
            },
            edit: {
    ...
    function initGlobalEvent() {
        ...
        */
        ...
        function moveSameLevelNode(targetNodeId, moveNodeId) {
            ...
            Util.ajax.putJson(Util.constants.CONTEXT + "/kc/doc/catalogsvc/msa/moveCatalog", params, function (result) {
    ...
    function saveNode(type) {
        ...
        if (type == '1') {//新增
            ...
            params = {
                suprCatlId: selectTreeNode.codeValue,
                catlNm: codeName,
                chnlCode: channelCode,
            };

            Util.ajax.postJson(Util.constants.CONTEXT + "/kc/doc/catalogsvc/msa/addDocCatalog", params, function (result) {
                //刷新节点
            ...
            params = {
                suprCatlId: selectTreeNode.getParentNode().codeValue,
                catlId: selectTreeNode.codeValue,
                catlNm: codeName,
                chnlCode: channelCode
            };

            Util.ajax.putJson(Util.constants.CONTEXT + "/kc/doc/catalogsvc/msa/modifyDocCatalog", params, function (result) {
                //刷新节点
            ...
            Util.ajax.deleteJson(Util.constants.CONTEXT + "/kc/doc/catalogsvc/msa/deleteDocCatalog?catlId=" + logicTreeCatlId, "", function (result) {
                //刷新节点

...
//      console.log(template(options))
    ...
    var showDrop = function(e){
        ...
        if(!this.$select.prop('disabled')){
            ...
            this.$analog.find('.sn-select-single').css({'border-color':"#e50017"});
        }
    }
    //选择下拉框内容并隐藏下拉面板

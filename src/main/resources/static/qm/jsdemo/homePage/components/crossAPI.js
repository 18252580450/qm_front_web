...
(function (_this,_func) {
    ...
    //消息发送--总方法
    function sendMsg(json,code){
        json.name=encodeURI(json.name);
        var data = JSON.stringify(json);
        writeLog(code,json.msgId,pageTitle,data);

...
<div class="t-list">
    ...
    <div class="t-list-search t-columns-3" id="klgData">
        <form id="form">
            ...
            <ul class="t-columns-group">
                ...
                <li class="width-1-3 form-has-link">
                ...
                <li class="width-1-3 form-has-link">
                    ...
                    <div id="chnlContiner" >
                        <input type="text" class="easyui-combotree"  name="knwlgChnlCode" id="knwlgChnlCode" style="height: 32px;">
                    </div>
                </li>
                <li class="width-1-3">
                    ...
                    <div>
                        <input type='text' class='easyui-datetimebox' name='knwlgEffTime' id='knwlgEffTime' style='width:100%;height:33px'>
                    </div>
                </li>
                <li class="width-1-3">
                    ...
                    <div>
                        <input type='text' class='easyui-datetimebox' name='knwlgInvldTime' id ='knwlgInvldTime'style='width:100%;height:33px'>
                    </div>
                </li>
                <li class="width-1-3">
                    <label for="businessOnlineTime">
                        业务上线时间
                    </label>
                    <div>
                        <input type='text' class='easyui-datetimebox' name='businessOnlineTime' id='businessOnlineTime' style='width:100%;height:33px'>
                    </div>
                </li>
                <li class="width-1-3">
                    <label for="businessOfflineTime">
                        业务下线时间
                    </label>
                    <div>
                        <input type='text' class='easyui-datetimebox' name='businessOfflineTime' id ='businessOfflineTime'style='width:100%;height:33px'>
                    </div>
                </li>
                <li class="width-1-3 form-has-link">
                    <label for="knwlgAls">
...
<div class="edit-sides-lock" {{#if batchFlag}}style="top: 10px"{{/if}}>
    <!-- 左侧非结构化知识 -->
    <div class="left-content" style="width:40%">
        <div class="ke-panel">
                    ...
                    <div class="ke-panel-content no-border">
                        ...
                        <div class="t-list-result ke-combo-table">
                            <table class="t-table t-table-striped dataTable">
                                ...
                                <tbody>
                                {{#each this.attr}}
                                <tr class="oldDataAttr vertical-top" id="{{atomId}}" requiredflag="{{requiredFlag}}"
                                    paratype="{{paraTypeCd}}">
                                    ...
                                    <td id="tdParaCntt{{atomId}}" class="tdcntt" atomid="{{atomId}}" >
                                        <div class="textarea-fold">
                                        <textarea class="f-ipt w280 txtContiner cnttTextBox" style="overflow-x:hidden"  atomid="{{atomId}}" name="{{paraNm}}" id="{{atomId}}" {{#equal ../../acceptPrePubFlag true}} readonly disabled="disabled" {{/equal}}>{{this.docKey.cntt}}</textarea>
            ...
            <div class="table-btm-btns" id="leftDivTableBtns">
                <a href="#nogo" class="t-btn t-btn-sm ml-5" id="copyStrTypeValueBtn">一键复制文本值</a>
                <a href="#nogo" class="t-btn t-btn-sm ml-5" id="showSrcFileBtn">源文件预览</a>
            </div>
        </div>
    </div>
    <!--右侧结构化知识-->
    <div class="right-content" style="left:40%">
        <div class="ke-panel">
                                ...
                                <tr class="dataTr vertical-top" id="{{atomId}}" requiredflag="{{requiredFlag}}"
                                    ...
                                    <td>
                                        ...
                                        <div class="field-error" id="errorWorm{{atomId}}">
                                            <select style="display:none" class="f-ipt w100 fn-fl typeOptnlSelect" name="{{paraTypeCd}}" atomid="{{atomId}}" atomnm="{{paraNm}}">
                                    ...
                                    <td id="tdcntt{{atomId}}" class="tdcntt" atomid="{{atomId}}" >
                                        ...
                                        <select class="f-ipt w100" name="wkunit" id="timePeriodUnit{{atomId}}"
                                                ...
                                                {{/isNotNull}}>
                                            {{#each ../../timePeriodUnit}}
                                            <option value="{{this.DATAVALUE}}">{{this.DATANAME}}
                                            </option>
                                            {{/each}}
                                        </select>
                                        {{/equal}}
                                        ...
                                        <select class="f-ipt w70" name="wkunit" id="memUnit{{atomId}}"
                                            ...
                                            {{#each ../../memUnit}}
                                            <option value="{{this.DATAVALUE}}" {{#equal ../docKey.wkunit this.DATAVALUE}} selected="selected"{{/equal}}>{{this.DATANAME}}</option>
                                            {{/each}}
                                        </select>
                                        {{/equal}}
                                        {{#equal paraTypeCd 10}}

                    ...
                    {{#each atrrItems}}
                        <div class="atoms" atomId="{{knwlgAttrAtomId}}">
                            ...
                            <div class="left-words" paraTypeCd="{{../paraTypeCd}}">
                                {{#equal isSendMes "1"}}
                                {{#equal ../paraTypeCd "4"}}
                                <a class="message rich-text attrData {{regnId}}" href="javascript:void(0);" id="{{../knwlgAttrAtomId}}"></a>
                                {{else}}
                                <a class="message normal-text attrData {{regnId}}" href="javascript:void(0);" id="{{../knwlgAttrAtomId}}"></a>
                                {{/equal}}
                                {{else}}
                                <a class="message  {{regnId}}" href="javascript:void(0);" id="{{../knwlgAttrAtomId}}"></a>
                                {{/equal}}
                                <span>{{../paraNm}}：</span>

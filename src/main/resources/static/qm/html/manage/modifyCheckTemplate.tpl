    ...
    <div id='layout_content' class='easyui-layout' data-options="region:'center'" style='overflow: auto; height:100%;'>
        <div data-options="region:'center'" style='overflow: auto;height: 100%'>
            <div id = "page">
                <div class='panel-search ' title="考评模板">
                    ...
                    <form class='form form-horizontal'>
                        <div class='row cl'>
                            ...
                            <div class='formControls col-2'>
                                <input  id='templateDesc' name = 'desc' data-options='multiline:true' class='easyui-textbox' style='height:30px;width:100%'/>
                            </div>
                        </div>
                    </form>
                </div>
                <div>
                    <!--左侧区域-->
                    <div style="float:left;overflow-y: auto; overflow-x: auto;width:20%;height: 400px;">
                        <div class='cl'>

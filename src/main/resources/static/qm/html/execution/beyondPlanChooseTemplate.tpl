        ...
        <div data-options="region:'center'" style='overflow: hidden;height: 100%'>
            <div id = "qryCheckTemplate_page">
                    ...
                    <form class='form form-horizontal' id = "searchForm">
                        ...
                        <!--<div class='row cl'>-->
                            ...
                            <div class='formControls col-3' style="text-align: right">
                                <a href='javascript:void(0)' class='btn btn-green radius mt-l-20' id = "queryBtn"><i class='iconfont iconfont-search2'></i>查询</a>
                                <a href='javascript:void(0)' class='btn btn-secondary radius mt-l-20 ' id="resetBtn"><i class='iconfont iconfont-zhongzuo'></i>重置</a>
                            </div>
                        </div>
                    </form>
                </div>
                <div class='cl'>
                    ...
                    <table id='checkTemplateList' name = 'checkTemplateManage' class='easyui-datagrid'  style=' width:100%;'>
                    </table>
                </div>
                <div class='mt-10 test-c'>
                    <label class='form-label col-5'></label>
                    <a href='javascript:void(0)' id='closeBtn' class='btn btn-secondary radius  mt-l-20'>关闭</a>
                </div>
            </div>
        </div>
    </div>

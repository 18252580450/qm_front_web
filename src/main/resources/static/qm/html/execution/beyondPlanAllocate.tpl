            ...
            <div id = "page">
                <div class='panel-search ' title="">
                    <form id="form" class='form form-horizontal'>
                        ...
                        <div class='row cl'>
                            <label class='form-label col-1'>考评模版</label>
                            <div class='formControls col-3'>
                                <input id="templateId" hidden="hidden" >
                                <input id="templateName" type='text' class="easyui-searchbox" style='width:100%;height:30px' >
                            </div>
                            <div class='formControls col-4' style="text-align: right">
                                <a href='javascript:void(0)' class='btn btn-green radius mt-l-20' id="queryBtn"><i
                                        class='iconfont iconfont-search2'></i>查询</a>
                                <a href='javascript:void(0)' class='btn btn-secondary radius  mt-l-20' id="resetBtn"><i
                ...
                <div>
                    <div class='cl'>
                        ...
                        <table id='staffList' class='easyui-datagrid' style='width:100%;'>
                        </table>
